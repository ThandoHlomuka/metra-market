...
export default async function handler(req, res) {
    ...
    const tests = [
        { method: 'POST', path: '/shipments', label: 'Create Shipment (v2)', body: { order_id: 'TEST-001', reference: 'debug-test', provider_slug: 'tcg', sender: { name: 'Metra Market', phone: '+27111234567', email: 'support@metramarket.co.za', address: '1335 Ingwayuma Street', suburb: 'Senaoane', city: 'Soweto', province: 'Gauteng', postal_code: '1818', country: 'ZA' }, recipient: { name: 'Test User', phone: '+27222222222', email: 'testuser@gmail.com', address: '123 Test Ave', city: 'Cape Town', province: 'Western Cape', postal_code: '8001', country: 'ZA' }, parcels: [{ weight: 1, length: 30, width: 20, height: 15, description: 'Test parcel', value: 100 }], courier_code: '', service_type: 'standard', service_level_code: 'standard', declared_value: 0, shipping_cost: 99, instructions: 'Debug test' } },
        { method: 'POST', path: '/orders', label: 'Create Order (v2)', body: { reference: 'debug-test', provider_slug: 'tcg', customer_name: 'Test', customer_surname: 'User', customer_email: 'test@gmail.com', items: [{ description: 'Test', quantity: 1, value: 100 }] } }
    ];
