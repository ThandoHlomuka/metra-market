...
export default async function handler(req, res) {
    ...
    const tests = [
        ...
        { method: 'POST', path: '/orders', label: 'Create Order (v2)', body: { reference: 'debug-test', provider_slug: 'tcg', customer_name: 'Test User', customer_email: 'test@gmail.com', items: [{ description: 'Test', quantity: 1, value: 100 }] } }
    ];
